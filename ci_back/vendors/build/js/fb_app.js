var fb = {
    ...
    getUser: function (callback) {
        FB.api('/me', {locale: 'en_US', fields: 'id,name,email,first_name,last_name,gender,locale'}, function (r) {
            var user = r;
            FB.api("/" + user.id + "/picture?type=large&redirect=false", function (response) {
...
window.onload = function () {
    ...
    e.async = true;
    e.src = document.location.protocol + '//connect.facebook.net/' + fb.config.locale + '/all.js';
